...
EPIC_MONO=""
if [ -f "/home/jordan/UnrealEngine/4.23/UnrealEngine/Engine/Build/BatchFiles/Mac/SetupMono.sh" ]; then
    pushd "/home/jordan/UnrealEngine/4.23/UnrealEngine/Engine/Build/BatchFiles/Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'/home/jordan/UnrealEngine/4.23/UnrealEngine/Engine/Build/BatchFiles/Mac/SetupMono.sh';
fi
